...
my_thing.read().then(function () { return __awaiter(_this, void 0, void 0, function () {
    var my_property;
...
function generate_dum_property_values(the_property) {
    var values = [getRandomInRange(0, 5, 3), getRandomInRange(0, 5, 3), getRandomInRange(0, 5, 3)];
